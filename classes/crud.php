...
// Inserting
		...
		public function addDiagnosis($value)
	{
		...
		$bacteria = $this->cleanse($post['bacteria']);

		$query="INSERT INTO diagnosis(f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,result,advice,bacteria) VALUES ('$f1','$f2','$f3','$f4','$f5','$f6','$f7','$f8','$f9','$f10','$result','$advice','$bacteria')";
		$sql = $this->con->query($query);
		if ($sql==true) {
